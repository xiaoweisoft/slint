...
<SlintProperty propName="horizontal-alignment" typeName="TextHorizontalAlignment" defaultValue="left">
Controls the horizontal alignment of the menu item's title in Slint-rendered menus.
Centered and right-aligned entries balance the leading icon/checkmark gutter and
the trailing submenu gutter around the title. Native operating-system menus may
ignore this visual hint.
</SlintProperty>
